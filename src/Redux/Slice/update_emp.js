...
export const update_emp_slice = createSlice({
  name: 'emp',
  initialState,
  reducers: {
    name: (state, action) => {
...
export const { name,email,Phone ,DOB,DOE,city,zip,address_line,isDelete} = update_emp_slice.actions

export default update_emp_slice.reducer